        ...
        <main className="min-h-screen bg-[#edf5f5] text-[#17304f]">
            <section className="mx-auto grid max-w-[1440px] gap-8 px-4 py-6 sm:px-7 sm:py-10 lg:grid-cols-[minmax(0,1.12fr)_minmax(440px,.88fr)] lg:items-start lg:gap-12 lg:px-12 lg:py-14">
                <div className="lg:sticky lg:top-8 lg:self-start">
                    ...
                    {image ? <div className="relative mt-8 overflow-hidden rounded-[2rem] bg-[#d3e7e4] shadow-[0_24px_65px_rgba(23,48,79,.18)]"><img src={image} alt={villa._embedded?.["wp:featuredmedia"]?.[0]?.alt_text || villa.title.rendered} className="aspect-[16/10] w-full object-cover sm:aspect-[4/3] lg:aspect-[5/4]" /><div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#17304f]/75 to-transparent px-6 pb-6 pt-16"><p className="max-w-lg text-sm leading-6 text-white">{villa.acf.description_long || villa.acf.description_short}</p></div></div> : null}
